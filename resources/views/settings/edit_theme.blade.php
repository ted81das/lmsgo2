                                ...
                                @if ($theme == 'theme1' || $theme == 'theme2' || $theme == 'theme3' || $theme == 'theme4')
                                    ...
                                    @if($theme == 'theme2')
                                        <a href="#Brand_Logo" id="Brand_Logo_tab"
                                            class="list-group-item list-group-item-action border-0">{{ __('Home Brand Logo') }}
                                            <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                                        </a>
                                    @endif
                                @endif
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            @if($field['field_type'] == 'multi file upload')
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" name="array[{{ $json_key }}][inner-list][{{ $inner_list_key }}][multi_image][]"
                                                                                ...
                                                                                <div class="row align-items-center">
                                                                                    <div class="col ml-n2">
                                                                                        <p class="card-text small text-muted">
                                                                                                    <input type="hidden" name='array[{{ $json_key }}][prev_image][]' value="{{ $file_pathh }}">
                                                                                                    <img class="rounded" src=" {{asset(Storage::url('uploads/'.$file_pathh))}}" width="70px" alt="Image placeholder" data-dz-thumbnail>
                                                                                                </p>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-auto actions">
                                                                                                <a name="deleteRecord" class="action-item deleteRecord"  data-name="{{ '/storage/uploads/'.$file_pathh }}">

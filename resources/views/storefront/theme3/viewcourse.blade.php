                                ...
                                <div class="user-review-content">
                                    <div class="abt-user">
                                        <div class="abt-usr-image">
                                            <img src="{{ asset('assets/themes/theme3/images/amelie.png') }}" alt="user">
                                        </div>
                                        <div class="user-info">
                                            <h4>
                                            ...
                                            <div class="course-reviews">
                                                ...
                                                <div class="course-review-profile">
                                                    <div class="course-review-profile-img">
                                                        <img src="{{ asset('assets/themes/theme3/images/amelie.png') }}" alt="">
                                                    </div>
                                                    <div class="user-info">
                                                        <h4>
                                                            {{$course_rating->name}}
                ...
                <div class="col-xl-5 col-lg-5 col-12 pdp-right-side">
                    <div class="pdp-main-itm">
                        <div class="pdp-main-media">
                            ...
                            @else
                                <img src="{{ asset('assets/themes/theme3/images/bachelor-of-sci.jpg') }}" alt="">
                            @endif
                            {{-- <img src="{{ asset('assets/themes/theme3/images/pdp-main-media.jpg') }}" alt=""> --}}
                        </div>
                    </div>
                    ...
                    <div class="description-image-right">
                        @if($course->is_preview == 'on')
                            @if($course->preview_type == 'Video File')
                                <video id="example" class="preview_video" poster="{{ asset('assets/themes/theme3/images/poster.jpg') }}" controls="" controlslist="nodownload" style="display: none;">
                            ...
                            <div class="col-md-4 col-sm-6 col-12  educator-card">
                                <div class="educator-card-inner">
                                    <div class="educator-image">
                                        <img src="{{ asset('assets/themes/theme3/images/poster.jpg') }}" alt="">

...
@section('content')
    ...
    <section class="common-banner-section blog-banner" style="background-image:url({{ asset('assets/themes/theme3/images/blog-banner.jpg') }});">
        <div class="container">
            <div class="row">
                        ...
                        <div class="blog-widget-inner">
                            <div class="blog-media">
                                <a href="{{route('store.store_blog_view',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($blogs->id)])}}">
                                    <img src="{{ asset('assets/themes/theme3/images/blog-image.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="blog-caption">
                                ...
                                @if ($blogs->detail)
                                    <div class="description"> {!! $blogs->detail !!}</div>
                                @else

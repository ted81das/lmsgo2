        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-12">
                        ...
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="payment-image d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/visa.png') }}" alt="">
                                    <img src="{{ asset('assets/imgs/mastercard.png') }}" alt="">
                                    <img src="{{ asset('assets/imgs/skrill.png') }}" alt="">
                                </div>
                            </div>
                            <p>{{ __('Safe money transfer using your bank account. We support Mastercard, Visa, Maestro and Skrill.') }}</p>
                            <form action="{{ route('stripe.post', $store->slug) }}" role="form" method="post"
                                class="payment-method-form" id="payment-form">
                                @csrf
                                <div class="form-group">
                                    <label for="card-name-on">{{ __('Name on card') }}</label>
                                    <input type="text" name="name" id="card-name-on" placeholder="Enter Your Name" class="required">
                                </div>
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <button type="submit" class="btn btn-secondary">{{ __('Pay Now') }}</button>
                                </div>
                            </form>
                        </div>
                    @endif
                    ...
                    @if ($store['enable_bank'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="payment-image d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/bank.png') }}" alt="Image placeholder">
                                </div>
                            </div>
                            {{-- <ul>
                                <li><b>Bank:</b> UNITED COMMUNITY BANK Bank</li>
                                <li><b>Account Number:</b> 67265159299 Routing</li>
                                <li><b>Number:</b> 71119865 IBAN</li>
                                <li>IN97350997896859414902082924</li>
                            </ul> --}}
                            <p>{{ $store->bank_number }}</p>
                            <form action="{{ route('user.bank_transfer', $store->slug) }}" method="POST"
                        ...
                        <div class="payment-method">
                            ...
                            <script>
                                function payWithPaystack() {
                                    ...
                                    var slug = '{{ $store->slug }}';
                                    var total_price =$('.total_price').attr('data-value') * 100;
                                    var coupon_id = $('.hidden_coupon').attr('data_id');
                                    var dicount_price = $('.dicount_price').html();
                                    // var discount_price = '{{ $store->slug }}';
                                    // console.log($('#total_value .total_price').attr('data-value'));
                            ...
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/paystack-logo.jpg') }}" alt="paystack">
                                </div>
                            </div>
                            ...
                            <div class="form-group text-right">
                                <input type="hidden" name="product_id">
                                <button type="submit" class="btn btn-secondary pay-btn"
                    ...
                    @if (isset($store_payments['is_paypal_enabled']) && $store_payments['is_paypal_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('PayPal') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/paypal.png') }}" alt="paypal">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}
                            </p>
                    ...
                    @if (isset($store_payments['is_flutterwave_enabled']) && $store_payments['is_flutterwave_enabled'] == 'on')
                        ...
                        <script>
                            function payWithRave() {
                                ...
                                var total_price = $('.total_price').attr('data-value');
                                    ...
                                    callback: function(response) {
                                        ...
                                        if (
                                            ...
                                            window.location.href = flutter_callback + '/{{ $store->slug }}/' + txref + '/' +
                                                    '{{\Illuminate\Support\Facades\Crypt::encrypt($order_id)}}';
                                        } else {
                        ...
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/flutterwave_logo.png') }}" alt="flutterwave">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase') }}.
                            </p>
                    ...
                    @if (isset($store_payments['is_razorpay_enabled']) && $store_payments['is_razorpay_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Razorpay') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/razorpay.png') }}" alt="razorpay">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase') }}.
                            </p>
                            ...
                            <div class="form-group text-right">
                                <input type="hidden" name="product_id">
                                <input type="hidden" name="amount">
                                <button type="submit" class="btn btn-secondary" onclick="payRazorPay()">{{ __('Pay Now') }}</button>
                            </div>
                            {{-- </form> --}}
                        </div>
                    @endif
                    ...
                    @if (isset($store_payments['is_paytm_enabled']) && $store_payments['is_paytm_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Paytm') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/Paytm.png') }}" alt="paytm">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}
                            </p>
                    ...
                    @if (isset($store_payments['is_mercado_enabled']) && $store_payments['is_mercado_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/mercadopago.png') }}" alt="mercado">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase') }}.
                            </p>
                    ...
                    @if (isset($store_payments['is_mollie_enabled']) && $store_payments['is_mollie_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Mollie') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/mollie.png') }}" alt="mollie">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}
                            </p>
                    ...
                    @if (isset($store_payments['is_skrill_enabled']) && $store_payments['is_skrill_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Skrill') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/skrill.png') }}" alt="skrill">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase') }}.
                            </p>
                    ...
                    @if (isset($store_payments['is_coingate_enabled']) && $store_payments['is_coingate_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('CoinGate') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/coingate.png') }}" alt="coingate">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase') }}.
                            </p>
                    ...
                    @if (isset($store_payments['is_paymentwall_enabled']) && $store_payments['is_paymentwall_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/imgs/paymentwall.png') }}" alt="">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase') }}.
                            </p>
                            <form method="POST" action="{{ route('paymentwall.session.store', $store->slug) }}"
                                class="payment-method-form">
                                @csrf
                                <input type="hidden" name="transaction_id" class="customer_product"
                                    value="{{ date('Y-m-d') . strtotime('Y-m-d H:i:s') . 'user_id' }}">
                                <input type="hidden" name="desc" value="{{ time() }}">
                                <div class="form-group text-right">
                                    <button type="submit" class="btn btn-secondary">{{ __('Pay Now') }}</button>
                    ...
                    <!-- Add money using Toyyibpay -->
                    @if (isset($store_payments['is_toyyibpay_enabled']) && $store_payments['is_toyyibpay_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Toyyibpay') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/paymentwall.png') }}" alt="Paymentwall">
                                </div>
                            </div>
                            ...
                            <form method="POST" action="{{ route('toyyibpay', $store->slug) }}" class="payment-method-form">
                                @csrf
                    ...
                    <!-- Add money using Payfast -->
                    @if (isset($store_payments['is_payfast_enabled']) && $store_payments['is_payfast_enabled'] == 'on' && $store_payments['payfast_merchant_id'] && $store_payments['payfast_merchant_key'])
                        <div class="payment-method">
                            ...
                            <form role="form" action={{"https://" . $pfHost . "/eng/process"}} method="post" class="require-validation" id="payfast-form" >
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <button type="submit" class="btn btn-secondary"  id="pay_with_payfast">{{ __('Pay Now') }}</button>
                                </div>
                            </form>
                        </div>
                    @endif
                    ...
                    <div class="checkout-right-side">
                                ...
                                <form action="">
                                    <div class="input-wrapper">
                                        <input type="text" id="stripe_coupon" name="coupon"
                                            placeholder="{{ __('Enter Coupon Code') }}" class="coupon">
                                        <input type="hidden" name="coupon" class="hidden_coupon" value="">
                                    </div>
                                    <div class="btn-wrapper">
                                        <button type="submit"
                                            class="btn btn-secondary apply-coupon">{{ __('Apply') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="mini-cart">
                            ...
                            <div class="mini-cart-header">
                                <h4>{{ __('My Cart') }}:<span class="checkout-cartcount">[{{ $total_item }}]</span>
                                </h4>
                            </div>
                            <div id="cart-body" class="mini-cart-has-item">
                                <div class="mini-cart-body">
                                        ...
                                        @foreach ($cart['products'] as $k => $value)
                                            ...
                                            <div class="mini-cart-item">
                                                <div class="mini-cart-image">
                                                    <a
                                                        href="{{ route('store.viewcourse', [$store->slug, \Illuminate\Support\Facades\Crypt::encrypt($value['id'])]) }}">
                                                        @if(!empty($value['image']))
                                                            <img src="{{asset($value['image'])}}" alt="img">
                                                        @else
                                                            <img src="{{ asset('assets/imgs/courses.png')}}" alt="img">
                                                        @endif
                                                        {{-- <img src="{{ asset('assets/imgs/courses.png') }}"
                                                            alt="img"> --}}
                                                    </a>
                                                </div>
                                                <div class="mini-cart-details">
                                                    <p class="mini-cart-title"><a
                                                            href="product.html">{{ $value['product_name'] }}</a></p>
                                                    <div
                                                        class="pvarprice d-flex align-items-center justify-content-between">
                                                        <div class="price">
                                                            <ins>{{ Utility::priceFormat($value['price']) }} </ins>
                                                            {{-- <del>$89 {{ Utility::priceFormat($course->discount)}}</del> --}}
                                                        </div>
                                                        <a class="remove_item" title="Remove item" href="#"
                                                            data-confirm="{{ __('Are You Sure?') . ' | ' . __('This action can not be undone. Do you want to continue?') }}"
                                                            data-confirm-yes="document.getElementById('delete-product-cart-{{ $k }}').submit();">
                                    ...
                                    {{-- <div class="mini-cart-item">
                                       <div class="mini-cart-image">
                                           <a href="product.html">
                                               <img src="assets/images/courses.png" alt="img">
                                           </a>
                                       </div>
                                       <div class="mini-cart-details">
                                           <p class="mini-cart-title"><a href="product.html">Vue - The Complete Guide (w/ Router, Vuex, Composition API)</a></p>
                                ...
                                <div class="mini-cart-footer">
                                    ...
                                    <div
                                        ...
                                        <div class="mini-total-price" id="total_value"
                                            data-value="{{ $total }}">
                                            <span class="total_price" data-value="{{ $total }}" >
                                                {{ Utility::priceFormat($total) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>

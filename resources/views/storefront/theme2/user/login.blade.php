                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-12">
                        <div class="login-left-side">
                            ...
                            <p>{{ __('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry') }}'{{ __('s standard dummy.') }}
                            </p>
                            <div class="form-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12 form-group">
                                        <label for="exampleInputEmail1">{{ __('Username') }}<sup
                                    ...
                                    <div class="col-12 form-footer d-flex align-items-center mobile-direction-column">
                                        <button type="submit" class="btn submit-btn"> {{ __('Login') }}<svg
                                                viewBox="0 0 10 5">
                                                <path

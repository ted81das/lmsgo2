                        ...
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="payment-image d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/visa.png') }}" alt="">
                                    <img src="{{ asset('assets/themes/theme2/images/mastercard.png') }}" alt="">
                                    <img src="{{ asset('assets/themes/theme2/images/skrill.png') }}" alt="">
                                </div>
                            </div>
                            ...
                            <div class="row payment-method-form">
                                <div class="col-md-6 form-group">
                                    <form action="{{ route('user.bank_transfer', $store->slug) }}" method="POST" class="" id="bank_transfer_form">
                                        {{-- <form action="{{ route('user.bank_transfer', $store->slug) }}" method="POST" class="payment-method-form" id="bank_transfer_form" enctype="multipart/form-data"> --}}
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                        ...
                        <div class="payment-method">
                            ...
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/paystack-logo.jpg') }}" alt="paystack">
                                </div>
                            </div>
                    ...
                    @if (isset($store_payments['is_paypal_enabled']) && $store_payments['is_paypal_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('PayPal') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/paypal.png') }}" alt="Paypal">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}</p>
                   ...
                   @if (isset($store_payments['is_flutterwave_enabled']) && $store_payments['is_flutterwave_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/flutterwave_logo.png') }}" alt="flutterwave">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}</p>
                            {{-- <form action="" class="payment-method-form"> --}}
                    ...
                    @if (isset($store_payments['is_razorpay_enabled']) && $store_payments['is_razorpay_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Razorpay') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/razorpay.png') }}" alt="Razorpay">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}</p>
                            {{-- <form action="" class="payment-method-form"> --}}
                    ...
                    @if (isset($store_payments['is_paytm_enabled']) && $store_payments['is_paytm_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Paytm') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/Paytm.png') }}" alt="Paytm">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}</p>
                    ...
                    @if (isset($store_payments['is_mercado_enabled']) && $store_payments['is_mercado_enabled'] == 'on')
                        <div class="payment-method">
                            ...
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/mercadopago.png') }}" alt="Mercado">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}</p>
                            {{-- <form action="" class="payment-method-form"> --}}
                    ...
                    @if (isset($store_payments['is_mollie_enabled']) && $store_payments['is_mollie_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Mollie') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/mollie.png') }}" alt="mollie">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}</p>
                    ...
                    @if (isset($store_payments['is_skrill_enabled']) && $store_payments['is_skrill_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('Skrill') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/skrill.png') }}" alt="skrill">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}</p>
                    ...
                    @if (isset($store_payments['is_coingate_enabled']) && $store_payments['is_coingate_enabled'] == 'on')
                        <div class="payment-method">
                            <div class="payment-title d-flex align-items-center justify-content-between">
                                <h4>{{ __('CoinGate') }}</h4>
                                <div class="payment-image extra-size d-flex align-items-center">
                                    <img src="{{ asset('assets/themes/theme2/images/coingate.png') }}" alt="Coingate">
                                </div>
                            </div>
                            <p>{{ __('Pay your order using the most known and secure platform for online money transfers. You will be redirected to PayPal to finish complete your purchase.') }}</p>
                            ...
                            <div class="coupon-body">
                                <form action="">
                                    <div class="input-wrapper">
                                        <input type="text" id="stripe_coupon" name="coupon" class="coupon" placeholder="Enter Coupon Code">
                                    </div>
                                            ...
                                            <div class="mini-cart-item">
                                                <div class="mini-cart-image">
                                                    <a href="{{ route('store.viewcourse', [$store->slug, \Illuminate\Support\Facades\Crypt::encrypt($value['id'])]) }}">
                                                        ...
                                                        @else
                                                            <img src="{{ asset('assets/themes/theme2/images/bachelor-of-sci.jpg')}}" alt="img">
                                                        @endif
                                                        {{-- <img src="{{ asset('assets/themes/theme2/images/courses.png') }}" alt="img"> --}}
                                                    </a>
                                                </div>

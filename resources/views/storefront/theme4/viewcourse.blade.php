...
@endsection
@push('css-page')
<link rel="stylesheet" href="{{asset('assets/themes/theme4/css/moovie.css')}}">
...
@endpush
@push('script-page')
    <script src="{{asset('assets/themes/theme4/js/moovie.js')}}"></script>
    <script>
                ...
                <div class="col-xl-7 col-lg-7 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        <div class="pdp-summery-top">
                            <div class="pdp-summery-back-btn">
                                <a href="{{route('store.slug',$store->slug)}}" class="back-btn back-btn-link">
                                ...
                                <div class="user-review-content">
                                    <div class="abt-user">
                                        <div class="abt-usr-image">
                                            <img src="{{ asset('assets/themes/theme4/images/amelie.png') }}" alt="user">
                                        </div>
                                        <div class="user-info">
                                            <h4>
                                            ...
                                            <div class="course-reviews">
                                                ...
                                                <div class="course-review-profile">
                                                    <div class="course-review-profile-img">
                                                        <img src="{{ asset('assets/themes/theme4/images/amelie.png') }}" alt="">
                                                    </div>
                                                    <div class="user-info">
                                                        <h4>
                                                            {{$course_rating->name}}
                ...
                <div class="col-xl-5 col-lg-5 col-12 pdp-right-side">
                    <div class="pdp-main-itm">
                        <div class="pdp-main-media">
                            ...
                            @endif
                            {{-- <img src="{{ asset('assets/themes/theme4/images/pdp-main-media.jpg') }}" alt=""> --}}
                        </div>
                    </div>
                        ...
                        <div class="summery-blocks">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <p>{{ $course->level }} <span>{{ __('Skill Level') }}</span></p>
                                </li>
                                <li>
                                    <span class="icon">
                                    ...
                                    {{-- <p>{{ __('Offline') }} <span>{{ _('videos') }}</span></p> --}}
                                    <p>{{ $course->tutor_id->name }} <span>{{ __('Educators') }}</span></p>
                                </li>
                                <li>
                                    <span class="icon">
                                ...
                                <li>
                                    ...
                                    <p>{{ __('Review') }} <span>{{$user_count}}</span></p>
                                </li>
                                <li>
                                    <span class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="description-image-right">
                        @if($course->is_preview == 'on')
                            @if($course->preview_type == 'Video File')
                                <video id="example" class="preview_video" poster="{{ asset('assets/themes/theme4/images/poster.jpg') }}" controls="" controlslist="nodownload" style="display: none;">
                ...
                <div class="col-lg-6 col-12">
                    <div class="syllabus-left-side">
                        ...
                        <p>
                            ...
                            take CS50x on your own schedule.</p>
                ...
                @else
                    ...
                    <div class="col-md-6">
                        <div class="requirement-right-side">
                            <ul>
                                <li>{{__('A broad and robust understanding of computer science and programming')}}</li>
                                <li>{{__('How to think algorithmically and solve programming problems efficiently')}}</li>
                                <li>{{__('Concepts like abstraction, algorithms, data structures, encapsulation, resource management, security, software engineering, and web development')}}</li>
                                <li>{{__('Familiarity with a number of languages, including C, Python, SQL, and JavaScript plus CSS and HTML')}}</li>
                                <li>{{__('How to engage with a vibrant community of like-minded learners from all levels of experience')}}</li>
                            </ul>
                        </div>
                    </div>
                @endif
                            ...
                            <div class="col-md-4 col-sm-6 col-12  educator-card">
                                <div class="educator-card-inner">
                                    <div class="educator-image">
                                        <img src="{{ asset('assets/themes/theme4/images/poster.jpg') }}" alt="">

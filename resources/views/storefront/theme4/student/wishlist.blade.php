                        ...
                        <a href="{{route('store.slug',$store->slug)}}" class="back-btn">
                            <span class="svg-ic">
                                <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5.40003 2.4C5.73138 2.4 6 2.66863 6 3C6 3.33137 5.73138 3.6 5.40003 3.6L2.04844 3.6L3.42412 4.97574C3.65842 5.21005 3.65842 5.58995 3.42412 5.82426C3.18982 6.05858 2.80993 6.05858 2.57563 5.82426L0.175729 3.42426C0.0632122 3.31174 8.15584e-07 3.15913 8.2254e-07 3C8.29496e-07 2.84087 0.0632123 2.68826 0.175729 2.57574L2.57563 0.175736C2.80993 -0.0585789 3.18982 -0.0585788 3.42412 0.175736C3.65843 0.410051 3.65843 0.78995 3.42412 1.02426L2.04844 2.4L5.40003 2.4Z" fill="#fff"></path>
                                </svg>
                            </span>
                            {{__('Back to Home')}}
                        </a>
                                    ...
                                    <div class="product-card-inner">
                                        ...
                                        <div class="product-img">
                                            <a href="{{ route('store.viewcourse', [$slug, \Illuminate\Support\Facades\Crypt::encrypt($course->id)]) }}">
                                                {{-- <img src="{{ asset('assets/themes/theme4/images/product-1.jpg') }}" alt=""> --}}

<head>
    ...
    @if(!empty($course))
        ...
        @else
            <meta property="twitter:image" content="{{asset('assets/themes/theme3/images/bachelor-of-sci.jpg')}}">
        @endif
    @endif
...
<!-- Favicon -->
    ...
    @if(!empty($store->store_theme))
        <link rel="stylesheet" href="{{asset('assets/themes/theme3/css/'.$store->store_theme)}}" id="stylesheet">
    @else
        <link rel="stylesheet" href="{{asset('assets/themes/theme3/css/light-blue-style.css')}}" id="stylesheet">
    @endif
    <link rel="stylesheet" href="{{ asset('assets/themes/theme3/css/responsive.css') }}">

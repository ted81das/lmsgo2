                        ...
                        {{Form::open(array('method'=>'post','id'=>'frmTarget','enctype'=>'multipart/form-data'))}}
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 col-lg-12">
                                    ...
                                    <textarea class="form-control summernote-simple" name="chapter_description" id="exampleFormControlTextarea1" rows="3" required></textarea>
                                ...
                                <div class="form-group col-md-12 col-lg-12" id="text_content_div">
                                    ...
                                    <textarea class="form-control summernote-simple" name="text_content" id="exampleFormControlTextarea2" rows="3"></textarea>

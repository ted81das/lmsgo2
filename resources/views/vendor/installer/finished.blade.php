...
@section('container')
    ...
    <p style="color:red;"><strong>Default Student Created : student@example.com / 1234</strong></p>
    <p style="color:red;"><strong>Default Author Created : author@example.com / 1234</strong></p>

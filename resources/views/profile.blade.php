                            ...
                            <div class="row">
                                @if(\Auth::user()->type=='client')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{Form::textarea('address_1', $client->address_1, ['class'=>'form-control','rows'=>'3'])}}
                                        @error('address_1')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{Form::textarea('address_2', $client->address_2, ['class'=>'form-control','rows'=>'3'])}}
                                        @error('address_2')
                                ...
                                @else
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {{Form::textarea('about',null,array('class'=>'form-control','placeholder'=>__(''),'rows' => 3))}}
                                            @error('about')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {{Form::textarea('description',null,array('class'=>'form-control','placeholder'=>__(''), 'rows' => 3))}}
                                            @error('description')

                                ...
                                <div class="card-body stats welcome-card">
                                    <div class="row align-items-center mb-4">
                                        <div class="col-xxl-12">
                                            ...
                                            <h4 class="f-w-400">
                                                <img src="{{ asset(Storage::url('uploads/profile/' . (!empty(Auth::user()->avatar) ? Auth::user()->avatar : 'avatar.png'))) }}" alt="user-image" class="wid-35 me-2 img-thumbnail rounded-circle">{{ __(Auth::user()->name) }}
                                            </h4>
                                            ...
                                            <div class="dropdown quick-add-btn">
                                                ...
                                                @if(Gate::check('create course') || Gate::check('create category') || Gate::check('create subcategory'))
                                                        ...
                                                        @foreach ($item_id as $k => $item)
                                                            @if ($product->id == $item)
                                                                <tr>
                                                                        ...
                                                                        <div class="media align-items-center gap-3">
                                                                            <div>
                                                                                @if (!empty($product->thumbnail))
                                                                                    <img alt="Image placeholder" src="{{ asset(Storage::url('uploads/thumbnail/' . $product->thumbnail)) }}" width="80px">
                                                                                @else
                                                                                    <img alt="Image placeholder" src="{{ asset(Storage::url('uploads/thumbnail/default.jpg')) }}" class="" style="width: 80px;">
                                                                                @endif
                                                                            </div>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <div>
                                                                            <span class="completion mr-2 text-dark text-right">{{ Utility::priceFormat($product->price) }}</span>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <a href="{{ route('orders.show', $order->id) }}" class="btn btn-outline-primary btn-sm text-sm order-badge">
                                                                ...
                                                                <td>
                                                                    <h6 class="m-0"> {{ Utility::priceFormat($order->price) }} <h6>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <div class="actions ml-3">
                                                                        <div class="d-flex align-items-center justify-content-end">
                                                                            ...
                                                                            <div class="action-btn bg-warning ms-2">
                                                                                <a href="{{ route('orders.show', $order->id) }}" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Details') }}"><i class="ti ti-eye text-white"></i></a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>

...
<div class="row">
        ...
        <div class="col-12">
            ...
            <div class="form-file mb-3">
                ...
                <a href="{{asset(Storage::url('uploads/category_image/'.$category->category_image))}}" target="_blank">
                    <img src="{{asset(Storage::url('uploads/category_image/'.$category->category_image))}}" name="category_image" id="category_image"  alt="user-image" class="avatar avatar-lg mt-3">
                </a>
    ...
    <div class="form-group col-md-12">
        ...
        {{Form::textarea('description',null,array('class'=>'form-control summernote-simple','rows'=>3,'placeholder'=>__('Description')))}}
    </div>

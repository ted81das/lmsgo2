...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('create blog'))
        {
            ...
            if(!empty($request->blog_cover_image))
            {
                ...
                // dd($fileNameToStoreBlog,$request,$dir);
                $path = \App\Models\Utility::upload_file($request,'blog_cover_image',$fileNameToStoreBlog,$dir,[]);
                // dd($path);
    ...
    {
        if(\Auth::user()->can('social media blog'))
        {
